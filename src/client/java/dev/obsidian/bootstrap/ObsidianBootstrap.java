...
public final class ObsidianBootstrap {
    ...
    public static void onMinecraftReady() {
        ...
        LOG.log(System.Logger.Level.INFO,
                "Obsidian Phase 3 dev23 P3.9 unselected-truth safety fallback armed. A-0185 closed full-volume benefit but found six deterministic unselected-slice render-truth changes after dev22 safely preserved same-section LIGHT_UPDATE intervals. Dev23 keeps the exact unselected per-slice fingerprint oracle unchanged and classifies only deterministic FAILURE_UNSELECTED_CHANGED outcomes as mandatory full-section fallback before localized completion/performance accounting. Nondeterminism and every other shadow failure remain correctness failures. Dev22 exact-section light-update admission remains unchanged. Production full-section invalidation/capture/mesh/upload/install/draw remains authoritative and unchanged; no request widening or slice-mask mutation occurs; packed light/color/material/geometry/UV/reference truth remains strict; partial GPU patching remains disabled. Frozen A-0159 thresholds, four fixed slices, permanent P3.7 oracle, greedy eligibility, shaders, pipelines, atlas/lightmap semantics, worker count/backpressure and resource lifetime remain unchanged; partialRemeshGpuInstallChanged=false, partialRemeshRenderedGeometryChanged=false, workerWorldReadsAfterCapture=0.");
    }
